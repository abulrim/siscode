...
<div class="wrapper">
	<div class="l-input">
		...
		<div class="l-input-expand-arrow"></div>
	</div>
...
<?php echo $this->HtmlLogic->startTemplate(array('id' => 'course-input-tmpl'));?>
	...
	<div class="cil-course-floats"><input type="text" class="cil-course-crn course-input" name="crn" value="{{crn}}" placeholder="CRN" /></div>
	<div class="cil-course-floats"><span name="remove" class="cil-remove-course"><i class="cil-remove-course-btn"></i></span></div>
	<div class="clear"></div>
<?php echo $this->HtmlLogic->endTemplate(); ?>
